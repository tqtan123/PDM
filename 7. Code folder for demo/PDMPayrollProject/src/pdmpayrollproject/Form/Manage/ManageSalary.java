...
public class ManageSalary extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        sql = "SELECT * FROM salary, payroll, employee WHERE salary_payroll_id = payroll_id AND payroll_employee_id = employee_id";
        rs = objSQLRun.sqlQuery(sql);
        
        try {
            while (rs.next()){
                model.addRow(new Object[]{rs.getString("salary_id"),rs.getString("employee_name"),rs.getString("salary_amount"),rs.getString("salary_description")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(ManageSalary.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if ( a==0){
            try{
                ...
                sql="DELETE FROM salary WHERE salary_id='" +selectedID+"'";
                objSQLRun.sqlUpdate(sql);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
        String department = txtEmployee.getText();
        String position = txtAmount.getText();
        int salary = Integer.parseInt(txtDescription.getText());
        ...
        if (validateFields("new")){
            ...
            try{
                ...
                sql="INSERT INTO job( job_basic_salary, job_department_id, job_position_id) "
                + "VALUE ('"+salary +"','"+deparment_id+ "','"+position_id+ "');";
