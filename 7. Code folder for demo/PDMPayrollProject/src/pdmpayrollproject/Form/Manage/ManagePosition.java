...
public class ManagePosition extends javax.swing.JFrame {
    ...
    private boolean validateFields(String formType){
        if(formType.equals("edit") && !txtID.getText().equals("") && !txtName.getText().equals("") ){
            return false;
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Position Manage");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            while (rs.next()){
                model.addRow(new Object[]{rs.getString("position_id"),rs.getString("position_name")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(ManagePosition.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if ( a==0){
            try{
                ...
                sql="DELETE FROM position WHERE position_id='" +selectedID+"'";
                objSQLRun.sqlUpdate(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagePosition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
