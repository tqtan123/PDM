...
import pdmpayrollproject.Form.Manage.Add.AddBonus;


public class ManageBonus extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        sql = "SELECT * FROM bonus, payroll, employee WHERE bonus_payroll_id = payroll_id AND payroll_employee_id = employee_id";
        rs = objSQLRun.sqlQuery(sql);
        
        try {
            while (rs.next()){
                model.addRow(new Object[]{rs.getString("bonus_id"),rs.getString("employee_name"),rs.getString("bonus_amount"),rs.getString("bonus_description")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(ManageBonus.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if ( a==0){
            try{
                ...
                sql="DELETE FROM bonus WHERE bonus_id='" +selectedID+"'";
                objSQLRun.sqlUpdate(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageBonus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
