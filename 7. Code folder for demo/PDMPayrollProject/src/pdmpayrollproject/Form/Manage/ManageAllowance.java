...
public class ManageAllowance extends javax.swing.JFrame {

    private int selectedID = 0;
    /**
     * Creates new form Employee
     */
    public ManageAllowance() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Employee", "Amount", "Description", "Status"
            }
        ) {
        ...
        btnAdd.setText("CHANGE STATUS TO APPROVED");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        sql = "SELECT * FROM allowance, payroll, employee WHERE allowance_payroll_id = payroll_id AND payroll_employee_id = employee_id";
        rs = objSQLRun.sqlQuery(sql);
        
        try {
            while (rs.next()){
                model.addRow(new Object[]{rs.getString("allowance_id"),rs.getString("employee_name"),rs.getString("allowance_amount"),rs.getString("allowance_description"),rs.getString("allowance_status")});
            }
    ...
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        ...
        String employee = model.getValueAt(index,1).toString();
        txtEmployee.setText(employee);
        
        String amount = model.getValueAt(index,2).toString();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if ( a==0){
            try{
                ...
                sql="DELETE FROM allowance WHERE allowance_id='" +selectedID+"'";
                objSQLRun.sqlUpdate(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageAllowance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
